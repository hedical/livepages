...
let EXPERT_DATA_URL = 'https://qzgtxehqogkgsujclijk.supabase.co/storage/v1/object/public/DataFromMetabase/expert_citae.json';
...
async function init() {
    ...
    if (!dataUrls) return;
    if (dataUrls.EXPERT_CITAE_URL) EXPERT_DATA_URL = dataUrls.EXPERT_CITAE_URL;
