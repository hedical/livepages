...
function loadParameters() {
    const saved = localStorage.getItem('chat_btpdiagnostics_parameters');
    if (saved) {
        try {
...
function saveParameters() {
    localStorage.setItem('chat_btpdiagnostics_parameters', JSON.stringify(parameters));
}
...
async function init() {
    try {
        ...
        console.log(`Loaded ${allData.length} chat sessions for BTP Diagnostics`);
