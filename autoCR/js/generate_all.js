// generate_all.js — Orchestration + ZIP (version navigateur)
// Dépend de : XLSX (global CDN), JSZip (global CDN), extract_data.js,
//             build_prev_nplus1.js, generate_cr.js

/**
 * Lance la génération de tous les CR et retourne un Blob ZIP.
 * @param {ArrayBuffer} xlsxBuffer  — Contenu du fichier .xlsx
 * @param {number}      moisIdx     — Index du mois (0=Janvier … 11=Décembre)
 * @param {string|null} drFilter    — Filtrer sur une DR (ex: "DR CENTRE-EST") ou null
 * @param {object|null} logoData    — { data: Uint8Array, type: 'png'|'jpeg' } ou null
 * @param {function}    onProgress  — Callback(done, total, nom, ok)
 * @returns {Promise<Blob>}         — ZIP contenant tous les .docx
 */
async function generateAll(xlsxBuffer, moisIdx, drFilter, logoData, onProgress) {
  // Lire le workbook
